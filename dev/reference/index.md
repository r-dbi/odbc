...
- [`Microsoft SQL Server-class`](https://odbc.r-dbi.org/dev/reference/SQLServer.md)
  ...
  [`odbcConnectionColumns,Microsoft SQL Server,character-method`](https://odbc.r-dbi.org/dev/reference/SQLServer.md)
  [`odbcConnectionColumns,Microsoft SQL Server,SQL-method`](https://odbc.r-dbi.org/dev/reference/SQLServer.md)
  : SQL Server

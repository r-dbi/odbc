...
for it to appear in
[`odbc::odbcListDrivers()`](https://odbc.r-dbi.org/reference/odbcListDrivers.md).
...
[`odbc::odbc()`](https://odbc.r-dbi.org/reference/dbConnect-OdbcDriver-method.md)
...
API—[`odbcListConfig()`](https://odbc.r-dbi.org/reference/odbcListConfig.md)

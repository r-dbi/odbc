...
- [`databricks()`](https://odbc.r-dbi.org/reference/databricks.md) now
  detects service principal credentials when running on Posit Connect
  ([@tnederlof](https://github.com/tnederlof),
  [\#931](https://github.com/r-dbi/odbc/issues/931)).

- [`databricks()`](https://odbc.r-dbi.org/reference/databricks.md) now
  has improved performance when the `useNativeQuery` connection
...
- [`odbc::snowflake()`](https://odbc.r-dbi.org/reference/snowflake.md)
...
- [`odbcConnectionColumns()`](https://odbc.r-dbi.org/reference/odbcConnectionColumns.md),
  [`odbcConnectionIcon()`](https://odbc.r-dbi.org/reference/odbcConnectionIcon.md),
  and
  [`odbcConnectionActions()`](https://odbc.r-dbi.org/reference/odbcConnectionActions.md)
...
- [`databricks()`](https://odbc.r-dbi.org/reference/databricks.md) and
  [`snowflake()`](https://odbc.r-dbi.org/reference/snowflake.md) now
  correctly error (instead of warning) when the driver configuration
  file is not found
...
- [`databricks()`](https://odbc.r-dbi.org/reference/databricks.md) and
  [`snowflake()`](https://odbc.r-dbi.org/reference/snowflake.md) detect
...
- New [`redshift()`](https://odbc.r-dbi.org/reference/redshift.md)
...
- [`snowflake()`](https://odbc.r-dbi.org/reference/snowflake.md) checks
  runtime driver configuration on macOS
  ([\#857](https://github.com/r-dbi/odbc/issues/857)).

- [`snowflake()`](https://odbc.r-dbi.org/reference/snowflake.md) accepts
  `uid` without `pwd` when using `authenticator = "externalbrowser"` or
...
- New function
  [`snowflake()`](https://odbc.r-dbi.org/reference/snowflake.md) makes
  it easier to connect to Snowflake, automatically handling
...
- [`databricks()`](https://odbc.r-dbi.org/reference/databricks.md) will
  now automatically configure the needed driver and driver manager on
  macOS ([@simonpcouch](https://github.com/simonpcouch),
  [\#651](https://github.com/r-dbi/odbc/issues/651)).

- [`databricks()`](https://odbc.r-dbi.org/reference/databricks.md) now
  picks up on Posit Workbench-managed Databricks credentials when
...
- [`databricks()`](https://odbc.r-dbi.org/reference/databricks.md) now
  works with manually supplied `pwd` and `uid`
...
- New
  [`odbc::databricks()`](https://odbc.r-dbi.org/reference/databricks.md)
...
- Added `attributes` parameter to `dbConnect(...)`. Can be used to pass
  ...
  [`?ConnectionAttributes`](https://odbc.r-dbi.org/reference/ConnectionAttributes.md)
  ([@detule](https://github.com/detule),

...
These instructions are for a Linux machine running Ubuntu 22.04. Oracle [just recently](https://github.com/oracle/python-cx_Oracle/issues/617#issuecomment-2182010721) released Instant Client for ARM64, so MacOS instructions may be coming down the line.

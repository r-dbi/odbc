...
* In the snowflake UI, navigate to the "Account Selector" in the bottom right corner. Then, follow the instructions [here](https://docs.snowflake.com/en/user-guide/admin-account-identifier#finding-the-organization-and-account-name-for-an-account) to copy your "Account Identifier".
...
Description =
uid         = <uid>
server      = <account-identifier>-<uid>.snowflakecomputing.com
```

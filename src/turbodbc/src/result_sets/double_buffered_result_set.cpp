...
namespace {
	...
	{
		return boost::apply_visitor(halve_buffer_size(), buffer_size);
	}

}

double_buffered_result_set::double_buffered_result_set(boost::shared_ptr<cpp_odbc::statement const> statement, turbodbc::buffer_size buffer_size) :

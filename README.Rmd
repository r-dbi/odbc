...
This gives a performant, easy to setup connection to any database with ODBC
drivers available, including SQL Server, Oracle, MySQL, PostgreSQL, SQLite and
others.

The implementation uses the [nanodbc](http://nanodbc.lexicalunit.com/) C++
library.

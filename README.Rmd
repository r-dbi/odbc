...
[![R build status](https://github.com/r-dbi/odbc/workflows/R-CMD-check/badge.svg)](https://github.com/r-dbi/odbc/actions?workflow=R-CMD-check)
[![Travis-CI Build Status](https://travis-ci.org/r-dbi/odbc.svg?branch=master)](https://travis-ci.org/r-dbi/odbc)

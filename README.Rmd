...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/2bnahh7qg5iu7197?svg=true)](https://ci.appveyor.com/project/hadley/odbc-cqvmd)

The goal of odbc is to provide a DBI-compliant interface to [Open
Database

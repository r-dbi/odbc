...
odbc_connect <- function(connection_string, timezone = "", timezone_out = "", encoding = "", column_name_encoding = "", bigint = 0L, timeout = 0L, r_attributes = NULL, interruptible_execution = TRUE) {
    .Call(`_odbc_odbc_connect`, connection_string, timezone, timezone_out, encoding, column_name_encoding, bigint, timeout, r_attributes, interruptible_execution)
}
